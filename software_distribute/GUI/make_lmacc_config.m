...
if (numrad == 157)
    ...
    str = ['smat_file = /mnt/ssd/eberg/sysmatrix_',num2str(numrad),'x156x111_1mmvoxel_',num2str(imgsize),'x',num2str(imgsize),'x445_compr, primate_nontof.acc_8x8x20.',num2str(numrad),'x156.sysmat.',num2str(imgsize),'x',num2str(imgsize),'x445x1.005x1.005x1.005.r1r\n'];
else
