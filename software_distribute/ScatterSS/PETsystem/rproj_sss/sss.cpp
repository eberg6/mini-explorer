...
/*
    Modified by Xuezhu Zhang
    3D version Date: December 2015
*/
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    plhs[0] = mxCreateDoubleMatrix(num_of_xps*nring*nring, 1, mxREAL);  // xzzhang
    REAL* S = mxGetPr(plhs[0]);
    

    int count_r1=0; // xzzhang
    ...
    for (INT r1 = 0; r1 < nring; r1 ++) {
        ...
        for (INT r2 = 0; r2 < nring; r2 ++) {
            ...
            INT rd_offset = (r1*nring + r2)*num_of_xps;
...
//                                        xtal2_x, xtal2_y, xtal2_z, emis_image) / d12;
                ...
                for (INT m = 0; m < scatter_point_buffer.size(); m ++) {
                    ...
                    S[n+rd_offset] += 1.0 / (len1_sq*len2_sq) * mu * KN * I * pb;        // xzzhang                   
                }
            }
