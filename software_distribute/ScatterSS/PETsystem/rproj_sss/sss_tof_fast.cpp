...
// read energy window and resolution
    ...
    plhs[0] = mxCreateDoubleMatrix(num_of_xps * nbin * nring*nring, 1, mxREAL);  // xzzhang
    ...
    for (INT r1 = 0; r1 < nring; r1 ++) {
        ...
        for (INT r2 = 0; r2 < nring; r2 ++) {
            ...
            for (n = 0; n < num_of_xps; n ++) { 
                ...
                // INT offset = n * nbin;
                INT rdt_offset = ((r1*nring + r2)*num_of_xps + n)*nbin;  // xzzhang
