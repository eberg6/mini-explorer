...
tbin_width = 4*scannerbxp.system_parms.tof_info(2);
...
fname33 = [fdir,'/sss_sino_tof_f',num2str(frame),'.raw']; 
fid33 = fopen(fname33,'wb'); 

fwrite(fid33,S_TOF,'double'); 
fclose(fid33); 	
pause(1); 							     
