function convert_desino(norm157,fdir)
...
data_fname = [fdir,'de_sino_157x156x111x111-float_sinorecon.raw']; 
fwrite(fopen(data_fname, 'w'), norm157sinorecon, 'float'); 

data_fname = [fdir,'de_sino_129x156x111x111-float_sinorecon.raw']; 
fwrite(fopen(data_fname, 'w'), norm129sinorecon, 'float'); 

data_fname = [fdir,'de_sino_77x156x111x111-float_sinorecon.raw']; 
